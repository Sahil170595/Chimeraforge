...
- **Throughput improvement:** -0.1% (98.43 → 98.30 tok/s)
- **TTFT reduction:** 9.0% (3963.03 → 3606.02 ms)
...
|--------|----------|---------|---|
| Average Throughput (tok/s) | 98.43 ± 0.00 | 98.30 ± 0.00 | -0.1% (-0.13) |
| Average TTFT (ms) | 3963.03 ± 0.00 | 3606.02 ± 0.00 | +9.0% (+357.01) |
| Total Tokens Generated | 1462 | 1533 | +71 |
| Avg Prompt Eval (ms) | 275.11 | 274.16 | -0.3% |
| Avg Eval Duration (ms) | 14853.66 | 15595.50 | +5.0% |
| Avg Load Duration (ms) | 3662.67 | 3328.71 | -9.1% |
...
### Throughput
- Baseline: 98.43 ± 0.00 tok/s (CV: 0.0%)
- Chimera: 98.30 ± 0.00 tok/s (CV: 0.0%)
- Improvement: -0.13 tok/s (-0.1%)

### TTFT
- Baseline: 3963.03 ± 0.00 ms (CV: 0.0%)
- Chimera: 3606.02 ± 0.00 ms (CV: 0.0%)
- Reduction: +357.01 ms (+9.0%)
...
|-----|-----------|-------------------|--------|---------------|
| 1 | 3963.03 | 98.43 | 1462 | 18858.67 |


### Chimera Individual Runs
| Run | TTFT (ms) | Throughput (tok/s) | Tokens | Duration (ms) |
|-----|-----------|-------------------|--------|---------------|
| 1 | 3606.02 | 98.30 | 1533 | 19245.84 |
...
The Rust agent with Chimera optimization achieved -0.1% higher throughput and 9.0% faster time-to-first-token compared to baseline configuration across 1 statistically significant runs.
...
2. **Latency**: TTFT improved by +9.0%, indicating faster initial response
3. **Consistency**: CV of 0.0% for throughput and 0.0% for TTFT demonstrates stable performance
4. **Total Tokens**: Generated 1533 tokens across 1 runs (1533 tokens/run average)
