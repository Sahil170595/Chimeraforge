...
- **TTFT reduction:** 11.7% (4573.03 → 4038.71 ms)
...
| Average TTFT (ms) | 4573.03 ± 0.00 | 4038.71 ± 0.00 | +11.7% (+534.31) |
...
### TTFT
- Baseline: 4573.03 ± 0.00 ms (CV: 0.0%)
- Chimera: 4038.71 ± 0.00 ms (CV: 0.0%)
- Reduction: +534.31 ms (+11.7%)
...
|-----|-----------|-------------------|--------|---------------|
| 1 | 4573.03 | 0.00 | 0 | 21139.30 |


### Chimera Individual Runs
| Run | TTFT (ms) | Throughput (tok/s) | Tokens | Duration (ms) |
|-----|-----------|-------------------|--------|---------------|
| 1 | 4038.71 | 0.00 | 0 | 19438.17 |
...
The Rust agent with Chimera optimization achieved 0.0% higher throughput and 11.7% faster time-to-first-token compared to baseline configuration across 1 statistically significant runs.
...
2. **Latency**: TTFT improved by +11.7%, indicating faster initial response
