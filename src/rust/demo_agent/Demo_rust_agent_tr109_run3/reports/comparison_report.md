...
- **TTFT reduction:** -2.0% (4200.53 → 4284.54 ms)
...
| Average TTFT (ms) | 4200.53 ± 0.00 | 4284.54 ± 0.00 | -2.0% (-84.01) |
...
### TTFT
- Baseline: 4200.53 ± 0.00 ms (CV: 0.0%)
- Chimera: 4284.54 ± 0.00 ms (CV: 0.0%)
- Reduction: -84.01 ms (-2.0%)
...
|-----|-----------|-------------------|--------|---------------|
| 1 | 4200.53 | 0.00 | 0 | 19144.80 |


### Chimera Individual Runs
| Run | TTFT (ms) | Throughput (tok/s) | Tokens | Duration (ms) |
|-----|-----------|-------------------|--------|---------------|
| 1 | 4284.54 | 0.00 | 0 | 19000.09 |
...
The Rust agent with Chimera optimization achieved 0.0% higher throughput and -2.0% slower time-to-first-token compared to baseline configuration across 1 statistically significant runs.
...
2. **Latency**: TTFT improved by -2.0%, indicating faster initial response
