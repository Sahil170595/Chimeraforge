...
- **TTFT reduction:** -0.1% (4238.11 → 4242.61 ms)
...
| Average TTFT (ms) | 4238.11 ± 0.00 | 4242.61 ± 0.00 | -0.1% (-4.49) |
...
### TTFT
- Baseline: 4238.11 ± 0.00 ms (CV: 0.0%)
- Chimera: 4242.61 ± 0.00 ms (CV: 0.0%)
- Reduction: -4.49 ms (-0.1%)
...
|-----|-----------|-------------------|--------|---------------|
| 1 | 4238.11 | 0.00 | 0 | 18486.56 |


### Chimera Individual Runs
| Run | TTFT (ms) | Throughput (tok/s) | Tokens | Duration (ms) |
|-----|-----------|-------------------|--------|---------------|
| 1 | 4242.61 | 0.00 | 0 | 20671.67 |
...
The Rust agent with Chimera optimization achieved 0.0% higher throughput and -0.1% slower time-to-first-token compared to baseline configuration across 1 statistically significant runs.
