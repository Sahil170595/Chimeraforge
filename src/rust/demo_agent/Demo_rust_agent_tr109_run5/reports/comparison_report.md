...
- **TTFT reduction:** 8.1% (3914.50 → 3598.58 ms)
...
| Average TTFT (ms) | 3914.50 ± 0.00 | 3598.58 ± 0.00 | +8.1% (+315.92) |
...
### TTFT
- Baseline: 3914.50 ± 0.00 ms (CV: 0.0%)
- Chimera: 3598.58 ± 0.00 ms (CV: 0.0%)
- Reduction: +315.92 ms (+8.1%)
...
|-----|-----------|-------------------|--------|---------------|
| 1 | 3914.50 | 0.00 | 0 | 18118.34 |


### Chimera Individual Runs
| Run | TTFT (ms) | Throughput (tok/s) | Tokens | Duration (ms) |
|-----|-----------|-------------------|--------|---------------|
| 1 | 3598.58 | 0.00 | 0 | 18732.23 |
...
The Rust agent with Chimera optimization achieved 0.0% higher throughput and 8.1% faster time-to-first-token compared to baseline configuration across 1 statistically significant runs.
