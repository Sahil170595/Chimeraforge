...
# MI300X 750W). Approximate; prefill MFU and the `measure` path absorb the slack.
GPU_DB: dict[str, GPUSpec] = {
    # Consumer - NVIDIA Ada
    "RTX 4060 8GB": GPUSpec("RTX 4060 8GB", 8.0, 272.0, 0.020, 30.2, 115.0),
    "RTX 4060 Ti 8GB": GPUSpec("RTX 4060 Ti 8GB", 8.0, 288.0, 0.025, 44.1, 160.0),
    "RTX 4060 Ti 16GB": GPUSpec("RTX 4060 Ti 16GB", 16.0, 288.0, 0.030, 44.1, 165.0),
    "RTX 4070 12GB": GPUSpec("RTX 4070 12GB", 12.0, 504.0, 0.030, 58.4, 200.0),
    "RTX 4070 Ti 12GB": GPUSpec("RTX 4070 Ti 12GB", 12.0, 504.0, 0.035, 80.2, 285.0),
    "RTX 4080 12GB": GPUSpec("RTX 4080 12GB", 12.0, 556.0, 0.035, 80.2, 285.0),
    "RTX 4080 16GB": GPUSpec("RTX 4080 16GB", 16.0, 717.0, 0.045, 97.5, 320.0),
    "RTX 4090 24GB": GPUSpec("RTX 4090 24GB", 24.0, 1008.0, 0.060, 165.2, 450.0),
    # Consumer - NVIDIA Blackwell (GDDR7)
    "RTX 5070 12GB": GPUSpec("RTX 5070 12GB", 12.0, 672.0, 0.030, 61.7, 250.0),
    "RTX 5070 Ti 16GB": GPUSpec("RTX 5070 Ti 16GB", 16.0, 896.0, 0.038, 87.9, 300.0),
    "RTX 5080 16GB": GPUSpec("RTX 5080 16GB", 16.0, 960.0, 0.045, 112.6, 360.0),
    "RTX 5090 32GB": GPUSpec("RTX 5090 32GB", 32.0, 1792.0, 0.075, 209.5, 575.0),
    # Consumer - NVIDIA Ampere
    "RTX 3090 24GB": GPUSpec("RTX 3090 24GB", 24.0, 936.0, 0.040, 71.0, 350.0),
    "RTX 3080 10GB": GPUSpec("RTX 3080 10GB", 10.0, 760.0, 0.025, 59.5, 320.0),
    # Data-center - NVIDIA
    "A100 40GB": GPUSpec("A100 40GB", 40.0, 1555.0, 1.10, 312.0, 400.0),
    "A100 80GB": GPUSpec("A100 80GB", 80.0, 2039.0, 1.60, 312.0, 400.0),
    "H100 80GB": GPUSpec("H100 80GB", 80.0, 3352.0, 2.50, 989.0, 700.0),
    "H200 141GB": GPUSpec("H200 141GB", 141.0, 4800.0, 3.50, 989.0, 700.0),
    "B200 180GB": GPUSpec("B200 180GB", 180.0, 7700.0, 5.50, 2250.0, 1000.0),
    "L4 24GB": GPUSpec("L4 24GB", 24.0, 300.0, 0.50, 121.0, 72.0),
    "T4 16GB": GPUSpec("T4 16GB", 16.0, 320.0, 0.35, 65.0, 70.0),
    # Data-center - AMD
    "MI300X 192GB": GPUSpec("MI300X 192GB", 192.0, 5300.0, 2.00, 1307.0, 750.0),
}
