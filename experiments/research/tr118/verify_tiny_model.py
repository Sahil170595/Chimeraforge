...
def main() -> int:
    ...
    parser.add_argument(
        "--processed-dir",
        default="research/tr118/results/tr118v2/20251213_135135_deep/tiny-gpt2/processed",
    ...
    parser.add_argument(
        "--output",
        default="research/tr118/results/tr118v2_audit/tiny_model_check.json",
    ...
    report = {
        ...
        "ratio_vs_uniform": (
            (ppl_from_nll / vocab_size) if ppl_from_nll and vocab_size else None
        ),
    }
