...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Verify TR118 run counts from JSONL data"
    )
    parser.add_argument(
        "--root",
        default="research/tr118/results/tr118v2/20251213_135135_deep",
    ...
    parser.add_argument(
        "--output",
        default="research/tr118/results/tr118v2_audit/run_counts.json",
