...
def _load_param_count(
    processed_dir: Path, repo_root: Path
    ...
    if model_cfg is None:
        ...
        if export_meta and export_meta.exists():
            ...
            onnx_inspect = (
                meta.get("onnx_inspect", {}) if isinstance(meta, dict) else {}
            )
...
def _fit_power_law(
    params: list[float], ratios: list[float], n_boot: int
) -> dict[str, Any]:
...
def main() -> int:
    ...
    parser.add_argument(
        "--output",
        default="research/tr118/results/tr118v2_audit/crossover_fit.json",
    ...
    candidates = [
        Path("research/tr118/results/tr118v2/20251213_135135_deep/tiny-gpt2/processed"),
        Path(
            "research/tr118/results/tr118v2/20251213_153314_gpt2_11m/gpt2-1m/processed"
        ),
        Path("research/tr118/results/validation_45m/processed"),
        Path("research/tr118/results/tr118v2_crossover/gpt2-5m/processed"),
        Path("research/tr118/results/tr118v2_crossover/gpt2-25m/processed"),
        Path("research/tr118/results/tr118v2_crossover/gpt2-50m/processed"),
        Path("research/tr118/results/tr118v2_crossover/gpt2-75m/processed"),
        Path("research/tr118/results/tr118v2_crossover/gpt2-100m/processed"),
        Path("research/tr118/results/tr118v2/20251213_135135_deep/gpt2/processed"),
    ]
