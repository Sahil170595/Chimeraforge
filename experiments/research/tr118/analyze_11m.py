...
# Load 11M model data
gpt11m_prefill = pd.read_csv(
    "results/tr118v2/20251213_153314_gpt2_11m/gpt2-1m/processed/latency_summary_prefill.csv"
)
gpt11m_generate = pd.read_csv(
    "results/tr118v2/20251213_153314_gpt2_11m/gpt2-1m/processed/latency_summary_generate.csv"
)

# Aggregate by backend (overall means)
print("=== GPT-2 11M (11.18M params) PREFILL RESULTS ===")
gpt11m_p_agg = (
    gpt11m_prefill.groupby("backend")["throughput_mean_tok_s"]
    .mean()
...
gpt11m_g_agg = (
    gpt11m_g_valid.groupby("backend")["throughput_mean_tok_s"]
    .mean()
    .sort_values(ascending=False)
)
...
# Load param count
with open(
    "results/tr118v2/20251213_153314_gpt2_11m/gpt2-1m/processed/experiment_manifest_1765657995.json"
) as f:
