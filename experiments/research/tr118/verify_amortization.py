...
def main() -> int:
    ...
    parser.add_argument(
        "--latency-summary",
        default="research/tr118/results/tr118v2/20251213_135135_deep/gpt2/processed/latency_summary_prefill.csv",
    ...
    parser.add_argument(
        "--output",
        default="research/tr118/results/tr118v2_audit/amortization_check.json",
