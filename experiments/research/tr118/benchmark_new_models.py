...
def benchmark_model(model_name: str, model_path: Path) -> int:
    ...
    # Setup paths
    base_cfg_path = resolve_repo_path(
        _REPO_ROOT, "research/tr118/configs/matrix_postdoc.yaml"
    )
    results_dir = _REPO_ROOT / "research/tr118/results/tr118v2_crossover" / model_name
...
def main() -> int:
    ...
    for name, path in models:
        ...
        print(f"  {name:15} {path!s:20} [{status}]")
    print()
