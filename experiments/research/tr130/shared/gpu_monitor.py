...
and returns timestamped samples.  Copied from TR129, adapted for TR130.
"""
...
log = logging.getLogger("tr130.gpu_monitor")
...
class GpuMonitor:
    ...
    def start(self) -> None:
        ...
        self._thread.start()
        log.info(
            "GPU monitor started (%.1fs interval, %.0fC, %.0f MB VRAM)",
            self._interval,
            test.temp_c,
            test.mem_total_mb,
        )
