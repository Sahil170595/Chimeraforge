...
and returns timestamped samples.  This is what turns "latency went up"
into "latency went up because GPU hit 83 C and throttled."
"""
...
log = logging.getLogger("tr128.gpu_monitor")
...
class GpuMonitor:
    ...
    def start(self) -> None:
        ...
        # Verify nvidia-smi works before starting
        test = _poll_once()
        if test is None:
    ...
    def summarize(samples: list[GpuSample]) -> dict:
        ...
        # Thermal throttle detection: temp > 80C and clock drops > 10%
