...
Located in experiments/TR117_multiagent/scripts/ to avoid modifying core code.
"""
...
def parse_args():
    ...
    parser.add_argument("--output-dir", default="experiments/TR117_multiagent/results/phase3")
