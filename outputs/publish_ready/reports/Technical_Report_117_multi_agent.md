...
**Data Availability:**
All raw data, instrumentation scripts, and analysis notebooks are available in `experiments/TR117_multiagent/`.

**Reproducibility:**
To reproduce this analysis:
1. Run `python experiments/TR117_multiagent/scripts/profiler_agent.py --model gemma3:latest --runs 5`
2. Run `python experiments/TR117_multiagent/scripts/throttled_agent.py --throttle-rate 60 --runs 5`
3. Analyze with: `python experiments/TR117_multiagent/analyze_results.py`
