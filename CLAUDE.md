...
**Version:** 0.28.0 | **License:** MIT | **Python:** >=3.10 | **Rust:** >=1.70
...
# Run tests (1244 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 39 files, 1244 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1244 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1244 tests, 39 files -- planner/bench split per-concern after 0.3.0):
