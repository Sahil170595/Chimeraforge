...
**Version:** 0.20.0 | **License:** MIT | **Python:** >=3.10 | **Rust:** >=1.70
...
# Run tests (897 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 29 files, 897 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 897 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (897 tests, 29 files -- planner/bench split per-concern after 0.3.0):
