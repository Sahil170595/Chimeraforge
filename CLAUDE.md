...
**Version:** 0.30.9 | **License:** MIT | **Python:** >=3.10 | **Rust:** >=1.70
...
# Run tests (1521 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 48 files, 1521 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1521 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1521 tests, 48 files -- planner/bench split per-concern after 0.3.0):
