...
**Version:** 0.27.0 | **License:** MIT | **Python:** >=3.10 | **Rust:** >=1.70
...
# Run tests (1232 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 39 files, 1232 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1232 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1232 tests, 39 files -- planner/bench split per-concern after 0.3.0):
