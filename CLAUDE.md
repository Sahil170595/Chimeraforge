...
# Run tests (1175 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 38 files, 1175 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1175 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1175 tests, 38 files -- planner/bench split per-concern after 0.3.0):
