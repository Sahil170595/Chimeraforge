...
# Run tests (1379 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 44 files, 1379 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1379 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1379 tests, 44 files -- planner/bench split per-concern after 0.3.0):
