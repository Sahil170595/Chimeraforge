...
# Run tests (1482 total; 0.6.0 adds KV-batch/prefill-decode/continuous-batching/variance/pareto/accuracy + blind-audit regressions)
pytest tests/ -v
...
tests/                                # 47 files, 1482 tests (planner/bench split per-concern; test_accuracy falsifiability gates)
...
```bash
pytest tests/ -v                    # 1482 total tests
pytest tests/ --cov=src             # With coverage
```

**Layout** (1482 tests, 47 files -- planner/bench split per-concern after 0.3.0):
